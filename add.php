     	 	...
     	 	<h2>Add a questions</h2>
               ...
               <form method="post" action="add.php">
                    <div class="form-group">
                      ...
                      <input type="number" name="question_number" class="q_number" value="<?php echo $next; ?>">
                    </div>
                    <div class="form-group">
                      <label>Question text :</label>
                      <input type="text" name="question_text" class="q_text">
                    </div>
                    <div class="form-group">
                      <label>Choice 1 :</label>
                      <input type="text" name="choice1"  class="q_text">
                    </div>
                    <div class="form-group">
                      <label>Choice 2 :</label>
                      <input type="text" name="choice2"  class="q_text">
                    </div>
                    <div class="form-group">
                      <label>Choice 3 :</label>
                      <input type="text" name="choice3"  class="q_text">
                    </div>
                    <div class="form-group">
                      <label>Choice 4 :</label>
                      <input type="text" name="choice4"  class="q_text">
                    </div>
                    <div class="form-group">
                      <label>Correct choice number :</label>
                      <input type="number" name="correct_choice" class="q_number">
                    </div>
